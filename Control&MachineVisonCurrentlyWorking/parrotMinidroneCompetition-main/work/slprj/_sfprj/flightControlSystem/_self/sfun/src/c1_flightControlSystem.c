  ...
  (SFc1_flightControlSystemInstanceStruct *chartInstance)
{
  ...
  covrtEmlFcnInitFcn(chartInstance->c1_covrtInstance, 4U, 0U, 0U,
                     "c1_flightControlSystem", 0, -1, 1175);
}
  ...
  (SFc1_flightControlSystemInstanceStruct *chartInstance)
{
  ...
  for (c1_i51 = 0; c1_i51 < 19200; c1_i51++) {
    (*chartInstance->c1_bw_image)[c1_i51] = ((real_T)c1_gray_image[c1_i51] >
      c1_d1);
  }

  for (c1_i52 = 0; c1_i52 < 19200; c1_i52++) {
    covrtSigUpdateFcn(chartInstance->c1_covrtInstance, 1U, (real_T)
                      (*chartInstance->c1_bw_image)[c1_i52]);
  }
}
  ...
  (SFc1_flightControlSystemInstanceStruct *chartInstance)
{
  ...
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", *chartInstance->c1_bw_image, 11, 0U,
  ...
  (SFc1_flightControlSystemInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  for (c1_i = 0; c1_i < 19200; c1_i++) {
    (*chartInstance->c1_bw_image)[c1_i] = c1_bv[c1_i];
  }
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_rgb_image = (uint8_T (*)[57600])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c1_bw_image = (boolean_T (*)[19200])
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3633318544U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1303283051U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2662688533U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1934634948U);
}
...
static const mxArray *sf_get_sim_state_info_c1_flightControlSystem(void)
{
  ...
  mxArray *mxVarInfo = sf_mex_decode(
    ...
    "Kz7y0fLD5FgwI89kImM8JFYeAD/aU6RdxQNfPgkU/B5J+ASg/qTw+MzcxPZUPKg4AvUgPlA=="
    );
...
{
  return "sXaMqWtM2aqtcbc65rreKwB";
}
...
const char* sf_c1_flightControlSystem_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [20] = {
    "eNrdWE9v3EQUn01D1CKIilRRDkj0yLFQgTig0mT/tKtmyQpv2ohLNWs/26OMx975s5vlK/BxuHD",
    "mAwDixMfgyJE3Xu9mcZZkxis1LZYc59n+zXvvN++fl7T6A4LHPp7P7hOyh9fbeO6QxfFOJbfWzs",
    "X9XfJ1JQ/fJSRMqdR9EefE/wjzCBIQgYljdu6JFSYbUkkz1UCvoBl8ByrnRrNc+BnPRAwSRIgLF",
    "LnUXnoVywxn4qxnRGg1q5cpC9MgzQ2PDnFBGh0LPv8vvYXRQ9TYYRJC3QOIdCpzk6Q9TpOrWZB6",
    "1k4hPFMm8+ZKgQ5MYV1VA8M1Kzh0zyHsC6UpsqCu8TfQVENbn3tHCFPBEp1nBWdUuHOdUhVAgdG",
    "h4aSI8O+x0cieo17UN2aC6lwyyrsZb9sId8QOOdo5wLDm3jzrTHdgbJKEicSyK00GAv3HOHHgKm",
    "7nU5A0gWPhmYPWu+55ucGruHTPwb4Ny0Y5aLLFrqhG2FJvd4oMqYZ6e6FoU86VH3aUF0cwBV7q7",
    "1BNG2AX+j3ASrFolL+g0maBZyYZwSYGKmw7FxFz3+FpDVUW3G+xeDrAWWZDCiKkeWX6aqHrYtIo",
    "nWdtTKPO0ZGjvsvYvtAgYxqCc+2TlClAg8u48tQbMUXH3KKRJV166bwCiMZQomIjOrNcniHHvkX",
    "2giubCX5oiBLogIayYHQxul9QbhxtzhRWOBseJworlp9exNr8aQQOaZhCZPsJ4zAAZRdQzvUZ+8",
    "gBejtlet4BFUpWuGaSURBhI7EsjeYFnIgzkc9ET+ZZUE0EV8QVAFYNKgW2hUNsS3LeQ+PdrJYwG",
    "dnIajKeZVRzOrax8RQEdhbrq+2ENMSs6goc3dCgbbAB+wFbu1BMaRyn5t0yB6JyHv2o5TePflDJ",
    "j1a51FcjiTtFsQ0LnJQOxuWwByOWQXkjoDhTLMTqsHofkgu9d3au1ruD/7Ua4siWuGdruN0N/Hy",
    "4hrtbyeFnr2LOktQWYS1zHsyR9+yyHe858L3J/jqOXMJd8Ly8frqGb23QS9au2+zPkzXc+zU9uz",
    "XcXsXZH6etn+6dTn6cjH795ef57m/b6P/dM573K/nj5Xy26mDTS0XeJR7u1+LByuqUDiYv9eBzO",
    "tHhOPzyCynh+eywXO+Bp73L+w/w1Fjgynopw35UfWtZmZrFN4Bd/6s1e/euWf/OWjwR8tc32+Hv",
    "PanjN/F1u8aXlcezVyzDfrH/FtWLm6pPN2mnS/1qvWYcec24bf3zrctv+/sPr6gHpPb+3TfYj/q",
    "1aX9+0/z6k/j1o08q+fHq27mdMh5tmN6rxzhgx5ue/k/i+29P/pbzQtfyV/349/2jA0H5HMf1xe",
    "dQdXso7e9Oq0cSqNr8TXQTfcglv+3bt/6V37fI08PnjfvYP2NAAF4=",
    ""
  };
...
static void mdlSetWorkWidths_c1_flightControlSystem(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3003209938U));
  ssSetChecksum1(S,(2339461140U));
  ssSetChecksum2(S,(3268301937U));
  ssSetChecksum3(S,(3473177016U));
}
